...
urlpatterns = [
    ...
    path("Main/AdminMain/", views.AdminForm, name = "AdminMain"), #Создание страницы для админа
    path("login/", views.loginPage, name = "Login") ,# Логин в админ панель
    ...
    path('delete_uni/<int:id>/delete', views.UniDelete.as_view(), name = 'Uni_Detail' ), #Удаление модели Университета
    path('update_uni/<int:id>/update', views.UniUpdate.as_view(), name='Uni_Detail'), #Измененик модели Университета
]
